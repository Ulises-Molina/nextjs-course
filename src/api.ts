...
const api = {
  ...
  list: async (): Promise<Restaurant[]> => {
    ...
    const [, ...data] = await fetch("https://docs.google.com/spreadsheets/d/e/2PACX-1vRTaGJOjum7BLbWpKJU45d--PsA7O4ayCsBat8YSlMirBVrG1Qs7BGq83-6kJApUGObj0OkJTCURgxr/pub?output=csv").then(res => res.text()).then(text => text.split('\n'))
